function scr_en_weapon(name, is_man, man_number, man_type, group) {
	...
	switch(obj_ncombat.enemy){
		case 3:
			switch(name){
				case "Conversion Beam Projector":
					atta = 500;
					arp = 1;
					rang = 20;
					amm = 1;
				...
				case "Multi-Melta":
					...
					spli = 1;
					break;
				case "Melee Mechadendrites":
					atta = 100;
					arp = 1;
					rang = 1;
					spli = 3;
					break;
				case "Medium Vehicle Melee":
					atta = 80;
					arp = 0;
					rang = 1;
					spli = 1;
		...
		case 10: case 2: case 5: case 1:
			switch(name){
				...
				case "Bolter":
					...
					rang = 12;
					amm = 15;
					if (obj_ncombat.enemy == 5) { atta = 50; }
					break; // Bursts
				case "Power Fist":
					atta = 425;
					arp = 1;
				...
				case "Demolisher Cannon":
					...
					arp = 1;
					rang = 5;
					if (instance_exists(obj_nfort)) { rang = 6; }
					amm = 5;
					spli = 1;
					break;
